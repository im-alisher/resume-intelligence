...
const analysisBenefits = [
  { icon: '◎', title: 'ATS Score', description: 'See how well your resume performs with applicant tracking systems.', style: 'bg-cyan-400/10 text-cyan-300' },
  { icon: '⌕', title: 'Missing Skills', description: 'Discover important skills and keywords your resume may be missing.', style: 'bg-violet-400/10 text-violet-300' },
  { icon: '★', title: 'Actionable Advice', description: 'Get practical recommendations you can apply immediately.', style: 'bg-amber-400/10 text-amber-300' },
  { icon: '↗', title: 'Tailored Insights', description: 'Add a job description for deeper, role-specific analysis.', style: 'bg-emerald-400/10 text-emerald-300' },
]
